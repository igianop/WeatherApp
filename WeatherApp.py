...
def get_weather(entry):
    weather_key = '83b9bd554f1462e6c3181eea0a383553'
...
#83b9bd554f1462e6c3181eea0a383553
...
button  = tk.Button(frame, text="Get Wather", font=('Courier', 12), command=lambda: get_weather(entry.get()))
